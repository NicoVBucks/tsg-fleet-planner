const SC={success:{text:'#22d480',bg:'rgba(26,184,100,0.12)',bd:'rgba(26,184,100,0.3)'},warning:{text:'#f0a020',bg:'rgba(212,144,16,0.12)',bd:'rgba(212,144,16,0.3)'},danger:{text:'#ff5040',bg:'rgba(200,48,32,0.12)',bd:'rgba(200,48,32,0.3)'},info:{text:'#4db8ff',bg:'rgba(42,144,212,0.12)',bd:'rgba(42,144,212,0.3)'},stealth:{text:'#c888ff',bg:'rgba(168,85,247,0.12)',bd:'rgba(168,85,247,0.3)'},interdiction:{text:'#f0a020',bg:'rgba(212,144,16,0.12)',bd:'rgba(212,144,16,0.3)'},interceptor:{text:'#20d4c8',bg:'rgba(16,180,164,0.12)',bd:'rgba(16,180,164,0.3)'}};
...
const P1G2=[{role:'Pilot',n:1},{role:'Gunner',n:2}],P1G4=[{role:'Pilot',n:1},{role:'Gunner',n:4}],P1G6=[{role:'Pilot',n:1},{role:'Gunner',n:6}];
...
const SHIPS={
  ...
  sabre_comet:{name:'Aegis Sabre Comet',cls:'light',cat:'fighters',tunnel:true,stealth:true,slots:F},sabre_fb:{name:'Aegis Sabre Firebird',cls:'light',cat:'fighters',tunnel:true,stealth:true,slots:F},
  f7cs_1:{name:'Anvil F7C-S Hornet Ghost',cls:'light',cat:'fighters',tunnel:true,stealth:true,slots:F},f7cs_2:{name:'Anvil F7C-S Hornet Ghost Mk II',cls:'light',cat:'fighters',tunnel:true,stealth:true,slots:F},
  avenger_wl:{name:'Aegis Avenger Warlock',cls:'light',cat:'fighters',tunnel:true,interdiction:true,slots:F},sabre_raven:{name:'Aegis Sabre Raven',cls:'light',cat:'fighters',tunnel:true,interdiction:true,slots:F},mantis:{name:'RSI Mantis',cls:'light',cat:'fighters',tunnel:false,interdiction:true,slots:F},
  avenger_stk:{name:'Aegis Avenger Stalker',cls:'light',cat:'fighters',tunnel:true,interceptor:true,slots:F},origin_325a:{name:'Origin 325a',cls:'light',cat:'fighters',tunnel:true,interceptor:true,slots:F},
  ...
  f7cm_hs2:{name:'Anvil F7C-M Heartseeker Mk II',cls:'medium',cat:'fighters',tunnel:true,slots:P2},f7cm_sh1:{name:'Anvil F7C-M Super Hornet Mk I',cls:'medium',cat:'fighters',tunnel:true,slots:F},
  f7cm_sh2:{name:'Anvil F7C-M Super Hornet Mk II',cls:'medium',cat:'fighters',tunnel:true,slots:P2},santok:{name:"Aopoa San'tok.yāi",cls:'medium',cat:'fighters',tunnel:true,slots:F},
  ...
  vg_harb:{name:'Aegis Vanguard Harbinger',cls:'heavy',cat:'fighters',tunnel:false,slots:FG},vg_sent:{name:'Aegis Vanguard Sentinel',cls:'heavy',cat:'fighters',tunnel:false,slots:FG},
  vg_ward:{name:'Aegis Vanguard Warden',cls:'heavy',cat:'fighters',tunnel:false,slots:FG},f8c:{name:'Anvil F8C Lightning',cls:'heavy',cat:'fighters',tunnel:true,fav:true,slots:F},
  hurricane:{name:'Anvil Hurricane',cls:'heavy',cat:'fighters',tunnel:true,slots:FG},ares_i:{name:'Crusader Ares Inferno',cls:'heavy',cat:'fighters',tunnel:false,slots:F},
  ...
  guardian_mx:{name:'Mirai Guardian MX',cls:'heavy',cat:'fighters',tunnel:true,slots:F},guardian_qi:{name:'Mirai Guardian QI',cls:'heavy',cat:'fighters',tunnel:true,interdiction:true,slots:F},m80:{name:'Origin M80',cls:'heavy',cat:'fighters',tunnel:true,slots:F},
  ...
  hammerhead:{name:'Aegis Hammerhead',cls:'gunship',cat:'subcapital',tunnel:false,slots:P1G6},redeemer:{name:'Aegis Redeemer',cls:'gunship',cat:'subcapital',tunnel:false,slots:P1G4},
