...
const SHIPS={
  ...
  hurricane:{name:'Anvil Hurricane',cls:'heavy',cat:'fighters',tunnel:true,slots:P2G1},ares_i:{name:'Crusader Ares Inferno',cls:'heavy',cat:'fighters',tunnel:false,slots:F},
  ...
  hammerhead:{name:'Aegis Hammerhead',cls:'gunship',cat:'subcapital',tunnel:false,slots:P1G6},redeemer:{name:'Aegis Redeemer',cls:'gunship',cat:'subcapital',tunnel:false,slots:P4G4},
