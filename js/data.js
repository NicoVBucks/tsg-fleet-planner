const SC={success:{text:'#22d480',bg:'rgba(26,184,100,0.12)',bd:'rgba(26,184,100,0.3)'},warning:{text:'#f0a020',bg:'rgba(212,144,16,0.12)',bd:'rgba(212,144,16,0.3)'},danger:{text:'#ff5040',bg:'rgba(200,48,32,0.12)',bd:'rgba(200,48,32,0.3)'},info:{text:'#4db8ff',bg:'rgba(42,144,212,0.12)',bd:'rgba(42,144,212,0.3)'},stealth:{text:'#c888ff',bg:'rgba(168,85,247,0.12)',bd:'rgba(168,85,247,0.3)'}};
